...
return [
    ...
    'Invalid Social Profile, Try again' => 'Profilo errato, riprova',
    'Social User Not Found' => 'Profilo social non trovato',
    'Social Account Unlinked' => 'Profilo social Scollegato',
    "It is mandatory to accept the informations about the privacy" => "E' obbligatorio accettare le informazioni relative alla privacy",
    "Already registered" => "Utente già regisitrato",
    "Event does not exist" => "L'evento non esiste",
    "Disabilitato" => "Disabled",
    "Sei già registrato all'evento" => "You are already registered to the event",
    "Registrazioni chiuse" => "Registrations closed",
    "Registrazioni chiuse, i posti sono esauriti" => "Registrations closed, the seats are sold out",
    "Registrazioni aperte" => "Registrations opened",
    ...
    "City" => "Città",
    "Privacy" => "Privacy",
    "Il campo non può essere vuoto" => "Il campo non può essere vuoto"
